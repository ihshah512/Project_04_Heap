...
{
  m_heap = nullptr; // set the copyTo pointer to null
  m_size = 0;       // setting the copyTo size to 0
  ...
  {
    Post *current = rhs.m_heap; // created a pointer of current heap root
